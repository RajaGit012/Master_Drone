...
int main(int argc, char **argv)
{
	...
	if (pcl::io::loadPCDFile<pcl::PointXYZ>("/home/raja/bagfiles/Single_Helix", *sourceCloud) != 0)
	{
		return -1;
	}
	if (pcl::io::loadPCDFile<pcl::PointXYZ>("/home/raja/bagfiles/Algo_0.4_10", *targetCloud) != 0)
	{
		return -1;
	}
